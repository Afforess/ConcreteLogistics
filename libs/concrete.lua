...
concrete_data["assembling-machine"]         = {radius = 2, concrete = "concrete-cyan",         priority = 4 , icon_name = "assembling-machine-2"}
concrete_data["furnace"]                    = {radius = 1, concrete = "concrete-red",          priority = 3 , icon_name = "electric-furnace"}
...
concrete_data["generator"]                  = {radius = 2, concrete = "concrete-black",        priority = 5 , icon_name = "steam-engine"}
